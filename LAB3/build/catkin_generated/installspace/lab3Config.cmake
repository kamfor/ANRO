...
if("FALSE" STREQUAL "TRUE")
  set(lab3_SOURCE_PREFIX /home/kforysze/ANRO/LAB3/src)
  set(lab3_DEVEL_PREFIX /home/kforysze/ANRO/LAB3/devel)
  set(lab3_INSTALL_PREFIX "")
  set(lab3_PREFIX ${lab3_DEVEL_PREFIX})
else()
  set(lab3_SOURCE_PREFIX "")
  set(lab3_DEVEL_PREFIX "")
  set(lab3_INSTALL_PREFIX /home/kforysze/ANRO/LAB3/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'kforysze <kforysze@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kforysze/ANRO/LAB3/install/${idir}'.  Ask the maintainer 'kforysze <kforysze@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kforysze/ANRO/LAB3/install/lib;/opt/ros/kinetic/lib)
